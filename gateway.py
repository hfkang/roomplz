...
def login():
    ...
    head = """<head><title>Login</title>""" + favicons + """<script type="text/javascript" src="mainanalytics.js"></script></head>"""
...
def francis():
    ...
    head = """<head><title>Francis Kang</title>""" + favicons + """<script type="text/javascript" src="/personalanalytics.js"></script></head>"""
